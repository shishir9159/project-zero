...
/** TASK 1
  ...
  *  - Update the page fault handler so that if the page table entry has a copy-on-write permission,
  *    it copies the corresponding page and returns.
  *  Hint 1:
  *  - Check import.h. The required functionality has already been implemented.
  */
...
void exception_handler(void)
{
 ...
 unsigned int curID = get_curid();
  unsigned int trapno =(unsigned int) uctx_pool[curID].trapno;
